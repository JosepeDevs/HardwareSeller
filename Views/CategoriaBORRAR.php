...
if( $usuarioLogeado == false){
    session_destroy();
    print "CategoriasBORRARMensajes dice: no está user en session";
...
?>
        ...
        <div class="finForm">
            <h2><a href="CategoriaBORRAR.php?codigo=<?php print $codigo;?>&confirmacion=true">Sí, borrar el Categoria (Borrado lógico).</a></h2>
            <h2><a href="CategoriaBORRAR.php?codigo=<?php print $codigo;?>&confirmacion=false">Cancelar borrado.</a></h2>
        </div>
<?php
