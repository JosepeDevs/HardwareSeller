...
?>
        ...
        <div class="finForm">
            <h2><a href="PedidoBORRAR.php?idPedido=<? echo $idPedido;?>&confirmacion=true">Sí, cancelar pedido y sus contenidos.</a></h2>
            <h2><a href="PedidoBORRAR.php?idPedido=<? echo $idPedido;?>&confirmacion=false">Mantener pedido.</a></h2>
        </div>
<?php
